...
#' @param token [character]. A GitHub personal access token (PAT). Default is `gh::gh_token()`.
...
ngr_git_issue_details <- function(issue_url_json, token = gh::gh_token(), endpoint = "timeline", events_all = FALSE) {
