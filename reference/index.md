...
- [`ngr_fs_copy_if_missing()`](https://newgraphenvironment.github.io/ngr/reference/ngr_fs_copy_if_missing.md)
  : Copy files from one directory to another only if they don't already
  exist
...
- [`ngr_git_issue()`](https://newgraphenvironment.github.io/ngr/reference/ngr_git_issue.md)
...
- [`ngr_s3_keys_get()`](https://newgraphenvironment.github.io/ngr/reference/ngr_s3_keys_get.md)
...
- [`ngr_xl_map_formulas()`](https://newgraphenvironment.github.io/ngr/reference/ngr_xl_map_formulas.md)
  : Read Formulas and Column Names from an Excel Worksheet and Combine
  to Aid in Transformation of Formulas to R
